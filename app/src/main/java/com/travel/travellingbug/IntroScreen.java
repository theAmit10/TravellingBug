...
import com.travel.travellingbug.Adapter.IntroAdapter;
import com.travel.travellingbug.Model.IntroModel;
    ...
    private void componentClickHandler() {
        skipTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =  new Intent(IntroScreen.this, AuthScreen.class);
